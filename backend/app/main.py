...
from app.api import auth_router, free_trial_router, lotto_router, ops_router, admin_router, subscription_router, oauth_router, guest_router, notification_router, payment_router
